...
font_prop_bold = fm.FontProperties(
    fname=f"{find_current_path}/fonts/Sarabun-Bold.ttf")
font_prop_regular = fm.FontProperties(
    fname=f"{find_current_path}/fonts/Sarabun-Regular.ttf")
...
class Graph:
    def __init__(self):
        ...
        self.legend_y = 0.995
        # กำหนดตำแหน่งโหนดเอง
        self.pos = {1: (0, 1), 2: (0, 3), 3: (1, 1), 4: (2, 3), 5: (2, 1), 6: (2, 2),
                    7: (3, 1), 8: (3, 3), 9: (4, 2), 10: (5, 0), 11: (5, 1), 12: (5, 2),
                    13: (5, 3), 14: (6, 2), 15: (6, 3), 16: (7, 0), 17: (7, 2), 20: (6, -1), 19: (5, -1), 18: (3, -1)}
        ...
        self.distance_mapping = {'1': 'สายรถ 5 (5.8 km)', '2': 'สายรถ 543ก/1-34 (1.9 km)', '3': 'เดิน (0.14 km)', '4': 'สายรถ 175/2-22 (23 km)', '5': 'สายรถ 21/4-6 (10 km)', '6': 'เดิน (0.18 km)', '7': 'สายรถ 97/2-15 (12.8 km)', '8': 'สายรถ 33/2-6 (2.5 km)', '9': 'สายรถ 3-55 (7.1 km)', '10': 'เดิน (0.04 km)', '11': 'รถมินิบัส (37 km)', '12': 'สายรถ ต.156 (34.1 km)', '13': 'เดิน (0.6 km)',
                                 '14': 'เดิน (0.29 km)', '15': 'เดิน (0.21 km)', '16': 'เดิน (0.45 km)', '17': 'เดิน (0.3 km)', '18': 'เดิน (0.26 km)', '19': 'สายรถ 97/2-15 (13.2 km)', '20': 'สายรถ 529/4-28 (9.65 km)', '21': 'สายรถ 21/4-6 (3.5 km)', '22': 'เดิน (0.06 km)', '23': 'สายรถ 140/4-23E (17.05 km)', '24': 'สายรถ 140/4-23E (13.85 km)', '25': 'สายรถ 4-33E (12.75 km)', '26': 'เดิน (0.05 km)', '27': 'เดิน (0.4 km)', '28': 'เดิน (0.11 km)', '29': 'สายรถ 203 (0.95 km)', '30': 'สายรถ 90/1-27 (1 km)'}
        self.G = nx.DiGraph()
    ...
    def draw_graph(self):
        ...
        for (n1, n2), label in self.edge_labels.items():
            if label in ["14", "16", "19", "26"]:
                ...
                x, y = (self.pos[n1][0] + self.pos[n2][0]) / \
                    2, (self.pos[n1][1] + self.pos[n2][1]) / 2
            ax.text(x, y, label, fontsize=10, color='white',
                    bbox=dict(boxstyle="round,pad=0.3",
                              fc="red", ec="black", lw=1),
    ...
    def draw_shortest_path(self):
        ...
        for node, (x, y) in self.pos.items():
            if node in path:
                plt.text(x, y, str(node), fontsize=10, fontweight="bold", color="black",
                         verticalalignment="center", horizontalalignment="center")
            else:
                plt.text(x, y, str(node), fontsize=10, fontweight="bold", color="white",
                         verticalalignment="center", horizontalalignment="center")
        ...
        for i, (num, text) in enumerate(self.distance_mapping.items()):
            ...
            ax.text(legend_x, self.legend_y - i * self.line_spacing_egde, num,
                    ...
                    bbox=dict(boxstyle="round,pad=0.3",
                              fc=fc_color, ec=font_color, lw=1),
                    transform=ax.transAxes, verticalalignment='center', horizontalalignment='center', fontproperties=font_prop_bold)
            ax.text(legend_x + 0.03, self.legend_y - i * self.line_spacing_egde, text,
